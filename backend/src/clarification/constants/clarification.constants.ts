export const CLARIFICATION_ERROR = {
  ...
  MONGO_UNAVAILABLE: { code: "CLAR_009", message: "Clarification database unavailable" },
  DB_UNAVAILABLE: { code: "CLAR_009", message: "Clarification database unavailable" },
  MIN_ITEMS_NOT_MET: { code: "CLAR_010", message: "Minimum clarification items not answered" },
  SESSION_MISMATCH: { code: "CLAR_011", message: "Clarification session does not match flow session" }
} as const;

export type ClarificationErrorCode = keyof typeof CLARIFICATION_ERROR;

export const FLOW_ID_USER_6 = "user-6";

export const FLOW_PHASES = ["0", "1", "2", "3", "4", "5", "6", "7", "7.5", "8"] as const;
...
export type ClarificationStatus =
  (typeof CLARIFICATION_STATUS)[keyof typeof CLARIFICATION_STATUS];
...
export const JOURNEY_POOL_MAP: Record<string, string> = {
  J1: "J1",
  J2: "J2-V2",
  "J2-NEG": "NEG-V2",
  J3: "J3",
