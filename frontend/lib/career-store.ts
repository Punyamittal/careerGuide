...
import { careerProfiles, cosineSimilarity, type SkillAxis } from "@/lib/career-data";
...
/** @deprecated Use useCareerStore */
export const useCireernStore = useCareerStore;
